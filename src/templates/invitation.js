const invitationTemplate = ({ url, name }) => `<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
                        ...
                        <table border="0" cellspacing="0" cellpadding="0" width="100%">
                          <tr><td align="left">
                            <div style="line-height: 32px;">
                              <span style="font-family: &quot;Cera Pro&quot;, sans-serif; font-weight: bold; font-size: 23px; color: #363a57;">Hola, ${name}:</span>
                            </div>
                          </td></tr>
                        </table>
                      </div>
                  ...
                  <table border="0" cellspacing="0" cellpadding="0" width="100%" style="max-width: 552px;">
                    <tr><td align="left">
                      <div style="line-height: 20px;">
                        <span style="font-family: Helvetica, sans-serif; font-size: 15px; color: #363a57;">Hemos registrado con éxito tu usuario y ahora podrás crear tus campañas publicitarias en todos los medios que quieras. <br>
                        <br>
                          <span style="font-weight: normal;">Haz click en el botón </span>para crear una contraseña. </span>
                        </div>
                        <div style="height: 16px; line-height: 16px; font-size: 14px;">&nbsp;</div>
                      </td></tr>
                    </table>
                  ...
                  <div>
                    <table border="0" cellspacing="0" cellpadding="0" width="100%">
                      <tr><td align="center" valign="top" bgcolor="#ffffff" style="padding: 24px;">
                        <div>
                          <!--[if mso]>
                          <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="${url}" style="height:36px;v-text-anchor:middle;width:164;" arcsize="56%" stroke="f" fillcolor="#ff0354">
                          <w:anchorlock>
                          </w:anchorlock>
                          <center style="color: #ffffff; font-size: 15px; font-weight: bold; font-family: Arial, sans-serif;">Crear contraseña</center>
                          </v:roundrect>
                          <![endif]-->
                          <a target="_blank" href="${url}" style="background-color:#ff0354;font-size:15px;font-weight:bold;line-height:36px;width:164px;color:#ffffff;border-radius:20px;display:inline-block;font-family:Arial, sans-serif;text-align:center;text-decoration:none;-webkit-text-size-adjust:none;mso-hide:all">Crear contraseña</a>
                        </div>
                      </td></tr>
                    </table>
                  </div>

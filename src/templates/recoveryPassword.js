...
const recoveryPasswordTemplate = ({ url, name }) => `<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
									...
									<table border="0" cellspacing="0" cellpadding="0" width="100%" style="max-width: 552px;">
										<tr><td align="left">
											<div style="line-height: 20px;">
												<span style="font-family: Helvetica, sans-serif; font-size: 15px; color: #363a57;">¿No recuerdas tu contraseña?, ¿Ya buscaste en la libreta que nunca lees o las notas de tu celular?. Si en ninguna parte la encuentras, no te preocupes.<br>
												<br>
													<span style="font-weight: normal;">Haz click en el botón</span> para generar una nueva contraseña. </span>
												</div>
												<div style="height: 16px; line-height: 16px; font-size: 14px;">&nbsp;</div>
											</td></tr>
										</table>
									...
									<div>
										<table border="0" cellspacing="0" cellpadding="0" width="100%">
											<tr><td align="center" valign="top" bgcolor="#ffffff" style="padding: 24px;">
												<div>
													<!--[if mso]>
													<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="${url}" style="height:36px;v-text-anchor:middle;width:218;" arcsize="56%" stroke="f" fillcolor="#8116f2">
													<w:anchorlock>
													</w:anchorlock>
													<center style="color: #ffffff; font-size: 15px; font-weight: bold; font-family: Arial, sans-serif;">Reestablecer contraseña</center>
													</v:roundrect>
													<![endif]-->
													<a target="_blank" href="${url}" style="background-color:#8116f2;font-size:15px;font-weight:bold;line-height:36px;width:218px;color:#ffffff;border-radius:20px;display:inline-block;font-family:Arial, sans-serif;text-align:center;text-decoration:none;-webkit-text-size-adjust:none;mso-hide:all">Reestablecer contraseña</a>
												</div>
											</td></tr>
										</table>
									</div>
...
module.exports = { recoveryPasswordTemplate }

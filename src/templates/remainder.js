                ...
                <div>
					...
					<div>
						...
						<table border="0" cellspacing="0" cellpadding="0" width="100%" style="max-width: 600px;">
							<tr><td align="center" valign="top" bgcolor="#ffffff" style="padding: 24px;">
								<div>
									...
									<table border="0" cellspacing="0" cellpadding="0" width="100%" style="max-width: 552px;">
										<tr><td align="left">
											<div style="line-height: 20px;">
												<span style="font-family: Helvetica, sans-serif; font-size: 15px; color: #363a57;">Te recordamos que el proceso de implementación de tu campaña en medios puede tomar <span style="font-weight: normal;">hasta 48 horas</span> ya que debemos enviar las ordenes de inserción de publicidad a cada medio / plataforma.</span>
											</div>
											<div style="height: 16px; line-height: 16px; font-size: 14px;">&nbsp;</div>
										</td></tr>
									</table>
																		...
																		<table border="0" cellspacing="0" cellpadding="0" width="100%">
																			<tr><td align="left">
																				<div style="line-height: 25px;">
																					<span style="font-family: &quot;Cera Pro&quot;, sans-serif; font-weight: bold; font-size: 15px; color: #363a57;">Paso 1<br>
																					<span style="font-size: 23px;">Objetivo y Presupuesto</span>
																					</span>
																				</div>
																...
																<tr><td align="center" valign="top" bgcolor="#ffffff">
																	<div>
																		<table border="0" cellspacing="0" cellpadding="0" width="100%">
																			<tr><td align="left">
																				<div style="line-height: 25px;">
																					<span style="font-family: &quot;Cera Pro&quot;, sans-serif; font-weight: bold; font-size: 15px; color: #363a57;">Paso 2<br>
																					<span style="font-size: 23px;">Selección de medios</span>
																					</span>
																				</div>
																				<div style="height: 4px; line-height: 4px; font-size: 2px;">&nbsp;</div>
																			</td></tr>
																	...
																	<div>
																		<table border="0" cellspacing="0" cellpadding="0" width="100%">
																			<tr><td align="left">
																				<div style="line-height: 20px;">
																					<span style="font-family: Helvetica, sans-serif; font-size: 12px; color: #363a57;">Selecciona los medios o plataformas digitales en las que quieres que tus anuncios sean vistos, selecciona los formatos y dales una participación de presupuesto sobre el total de campaña.</span>
																				</div>
																			</td></tr>
																		</table>
																	</div>
																...
																<tr><td align="center" valign="top" bgcolor="#ffffff">
																	<div>
																		<table border="0" cellspacing="0" cellpadding="0" width="100%">
																			<tr><td align="left">
																				<div style="line-height: 25px;">
																					<span style="font-family: &quot;Cera Pro&quot;, sans-serif; font-weight: bold; font-size: 15px; color: #363a57;">Paso 3<br>
																					<span style="font-size: 23px;">Adjuntar multimedia</span>
																					</span>
																				</div>
																				<div style="height: 4px; line-height: 4px; font-size: 2px;">&nbsp;</div>
																			</td></tr>
																	...
																	<div>
																		<table border="0" cellspacing="0" cellpadding="0" width="100%">
																			<tr><td align="left">
																				<div style="line-height: 20px;">
																					<span style="font-family: Helvetica, sans-serif; font-size: 12px; color: #363a57;">Sube los anuncios según las medidas y tipo de formato solicitado por cada medio, así tu campaña estará pronto a salir al aire.</span>
																				</div>
																			</td></tr>
																		</table>
																	</div>
																...
																<tr><td align="center" valign="top" bgcolor="#ffffff">
																	<div>
																		<table border="0" cellspacing="0" cellpadding="0" width="100%">
																			<tr><td align="left">
																				<div style="line-height: 25px;">
																					<span style="font-family: &quot;Cera Pro&quot;, sans-serif; font-weight: bold; font-size: 15px; color: #363a57;">Paso 4<br>
																					<span style="font-size: 23px;">Realiza tu pago</span>
																					</span>
																				</div>
																				<div style="height: 4px; line-height: 4px; font-size: 2px;">&nbsp;</div>
																			</td></tr>
																	...
																	<div>
																		<table border="0" cellspacing="0" cellpadding="0" width="100%">
																			<tr><td align="left">
																				<div style="line-height: 20px;">
																					<span style="font-family: Helvetica, sans-serif; font-size: 12px; color: #363a57;">Paga tu campaña con el método de pago que desees desde Tarjeta de crédito o débito, como también transferencia Bancolombia, Efectivo, Nequi o PSE. Nuestra integración con <span style="font-weight: normal;">Wompi</span>
																					<span style="font-weight: normal;">, permite que tu pago sea rápido y seguro. </span>
																					</span>
																				</div>
																			</td></tr>
																		</table>
